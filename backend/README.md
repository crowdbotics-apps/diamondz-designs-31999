...
## Project Structure
    ...
    ├── diamondz_designs_31999  # Django project configurations
...
1. Clone this repo and `cd diamondz_designs_31999`
...
2. Clone this repo and `cd diamondz_designs_31999`
